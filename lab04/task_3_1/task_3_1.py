# Імпортуємо необхідні перерахування (Enums) і класи
...
# Клас Директор для керування створенням автомобілів
class Director:
...
# Тестування створення автомобілів через Директора
if __name__ == "__main__":
    sedan = Director.construct_sedan()
    suv = Director.construct_suv()
    hatchback = Director.construct_hatchback()
